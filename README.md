[overtone-README.md](https://github.com/user-attachments/files/27123697/overtone-README.md)
# 🎹 Overtone · 泛音
...
* 進入項目的 **SQL Editor**
* 複製 [`supabase/setup.sql`](https://github.com/onlonlonl/overtone/blob/main/supabase/setup.sql) 的內容粘貼進去
* 點 **Run**
...
把 [`supabase/edge-function.ts`](https://github.com/onlonlonl/overtone/blob/main/supabase/edge-function.ts) 的代碼給 Claude，請他部署 Edge Function，名稱為 `overtone-api`，設定 `verify_jwt: false`。
...
把 [`CLAUDE_INSTRUCTIONS.md`](https://github.com/onlonlonl/overtone/blob/main/CLAUDE_INSTRUCTIONS.md) 的內容給你的 Claude，記得把 `YOUR_PROJECT_ID` 換成你的 Supabase Project ID。Claude 需要連接 **Supabase MCP** 才能參與。
...
* Copy and paste the contents of [`supabase/setup.sql`](https://github.com/onlonlonl/overtone/blob/main/supabase/setup.sql)
* Click **Run**
...
Give Claude the code in [`supabase/edge-function.ts`](https://github.com/onlonlonl/overtone/blob/main/supabase/edge-function.ts) and ask to deploy it as an Edge Function named `overtone-api` with `verify_jwt: false`.
...
Give your Claude the instructions in [`CLAUDE_INSTRUCTIONS.md`](https://github.com/onlonlonl/overtone/blob/main/CLAUDE_INSTRUCTIONS.md) — replace `YOUR_PROJECT_ID` with your actual Supabase project ID. Claude needs **Supabase MCP** connected to participate.
...
6. Add a title and message, tap **SEND**
...
CC BY-NC 4.0 — see [LICENSE](https://github.com/onlonlonl/overtone/blob/main/LICENSE)
